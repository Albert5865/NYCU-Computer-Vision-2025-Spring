...
if __name__ == '__main__':
    ...
    test_parser.add_argument('--cuda', type=int, default=0)
    ...
    test_parser.add_argument('--derain_path', type=str, default="test/derain/", help='save path of test raining images')
    ...
    test_parser.add_argument('--ckpt_name', type=str, default="model.ckpt", help='checkpoint save path')
    ...
    if testopt.mode == 0:
        ...
        for name in derain_splits:
            ...
            derain_set = DerainDehazeDataset(testopt, addnoise=False, sigma=15)  # Use testopt
        ...
        test_set = TestSpecificDataset(testopt.derain_path)  # Pass directory directly
